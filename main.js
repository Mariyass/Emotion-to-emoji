...
classifier=ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/4P7uRBRbh/model.json",modelLoaded);
...
function speak(){
    ...
    speak_data2="the secend prediction is "+prediction_2;
